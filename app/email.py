...
def send_reset_email(user):
    ...
    send_email('Reset Password',sender=app.config['MAIL_USERNAME'],recepients=[user.email],text_body=render_template('admin/reset_password.txt',user=user, token=token),html_body=render_template('admin/reset_password.html',user=user, token=token))
